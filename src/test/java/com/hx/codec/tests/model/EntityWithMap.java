...
public class EntityWithMap {
    ...
    private Map<String, UpConnectReq> configMap;
    ...
    @Field(dataType = DataType.GENERIC_MAP_WITH_LEN, name = "configMap", lengthByteType = ByteType.BYTE, sort = 2, desc = "configMap", version = {2011, 2019}
            , args = "{\"keyType\":\"CHARSET_ENCODING_WITH_LEN_STRING\", \"valueType\":\"GENERIC_BEAN\"}")
    public Map<String, UpConnectReq> getConfigMap() {
        return configMap;
    }

    public void setConfigMap(Map<String, UpConnectReq> configMap) {
