...
import com.hx.codec.codec.array.UnsignedWordArrayWithLenCodec;
 ...
 */
public class UnsignedWordArrayWithLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordArrayWithLenCodec(byteOrder, lengthByteType);
    }
}
