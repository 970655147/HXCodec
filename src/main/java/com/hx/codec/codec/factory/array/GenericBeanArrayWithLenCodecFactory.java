 ...
 */
public class GenericBeanArrayWithLenCodecFactory implements AbstractCodecFactory {
    ...
    public AbstractCodec create(CodecFactoryContext context) {
        ...
        return new GenericBeanArrayWithLenCodec<>(new GenericBeanSchema<>(eleType, context.getVersion()), lengthByteType);
    }
}
