 ...
 */
public class ByteArrayWithEleLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new ByteArrayWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
}