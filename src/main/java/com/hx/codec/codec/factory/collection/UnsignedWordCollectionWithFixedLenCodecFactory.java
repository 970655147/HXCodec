...
import com.hx.codec.codec.collection.UnsignedWordCollectionWithEleLenCodec;
import com.hx.codec.codec.collection.UnsignedWordCollectionWithFixedLenCodec;
 ...
 */
public class UnsignedWordCollectionWithFixedLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordCollectionWithFixedLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
