 ...
 */
public class QWordArrayWithFixedLenCodecFactory implements AbstractCodecFactory<Long[], Long[]> {
    ...
    public AbstractCodec<Long[], Long[]> create(CodecFactoryContext context) {
        ...
        return new QWordArrayWithEleLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
}