 ...
 */
public class WordCollectionWithEleLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new WordCollectionWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
