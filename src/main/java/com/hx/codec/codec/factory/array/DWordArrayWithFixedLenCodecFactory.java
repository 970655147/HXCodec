 ...
 */
public class DWordArrayWithFixedLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new DWordArrayWithFixedLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
}