 ...
 */
public class WordArrayWithFixedLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new WordArrayWithFixedLenCodec(byteOrder, eleLength);
    }
}