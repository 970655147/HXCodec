 ...
 */
public class DWordArrayWithEleLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new DWordArrayWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
}