 ...
 */
public class DWordCollectionWithFixedLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new DWordCollectionWithFixedLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
