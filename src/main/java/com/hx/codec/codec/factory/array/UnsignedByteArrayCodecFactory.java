...
import com.hx.codec.codec.array.UnsignedByteArrayCodec;
 ...
 */
public class UnsignedByteArrayCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new UnsignedByteArrayCodec(byteOrder);
    }
}
