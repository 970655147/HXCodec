 ...
 */
public class UnsignedByteArrayWithEleLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new UnsignedByteArrayWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
}