 ...
 */
public class DWordArrayWithExactlyLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new DWordArrayWithExactlyLenCodec(byteOrder, eleLength);
    }
}