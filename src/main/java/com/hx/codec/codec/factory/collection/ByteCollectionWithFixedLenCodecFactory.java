 ...
 */
public class ByteCollectionWithFixedLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new ByteCollectionWithFixedLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
