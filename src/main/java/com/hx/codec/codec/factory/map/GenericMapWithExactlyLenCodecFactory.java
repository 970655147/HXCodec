 ...
 */
public class GenericMapWithExactlyLenCodecFactory implements AbstractCodecFactory {
    ...
    public AbstractCodec create(CodecFactoryContext context) {
        ...
        if (CodecUtils.isNotBlank(fieldAnno.args())) {
            ...
            if (keyCodec != null && valueCodec != null) {
                return new GenericMapWithExactlyLenCodec(keyCodec, valueCodec, eleLength);
            }
        }

        return new GenericMapWithExactlyLenCodec(
