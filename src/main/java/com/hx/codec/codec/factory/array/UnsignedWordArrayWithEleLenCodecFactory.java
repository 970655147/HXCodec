 ...
 */
public class UnsignedWordArrayWithEleLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordArrayWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
}