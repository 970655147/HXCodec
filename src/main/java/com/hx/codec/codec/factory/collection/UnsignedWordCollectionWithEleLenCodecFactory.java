 ...
 */
public class UnsignedWordCollectionWithEleLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordCollectionWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
