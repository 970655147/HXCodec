 ...
 */
public class UnsignedByteCollectionWithEleLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedByteCollectionWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
