...
import com.hx.codec.codec.collection.DWordCollectionWithExactlyLenCodec;
 ...
 */
public class DWordCollectionWithExactlyLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new DWordCollectionWithExactlyLenCodec(byteOrder, eleLength);
    }
