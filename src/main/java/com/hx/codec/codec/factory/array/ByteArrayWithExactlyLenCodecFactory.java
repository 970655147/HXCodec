...
import com.hx.codec.codec.array.ByteArrayWithExactlyLenCodec;
 ...
 */
public class ByteArrayWithExactlyLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new ByteArrayWithExactlyLenCodec(byteOrder, eleLength);
    }
}