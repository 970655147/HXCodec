 ...
 */
public class ByteCollectionWithExactlyLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new ByteCollectionWithExactlyLenCodec(byteOrder, eleLength);
    }
