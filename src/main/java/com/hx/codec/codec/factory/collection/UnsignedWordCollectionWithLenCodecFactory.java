...
import com.hx.codec.codec.collection.UnsignedWordCollectionWithLenCodec;
 ...
 */
public class UnsignedWordCollectionWithLenCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordCollectionWithLenCodec(byteOrder, lengthByteType);
    }
