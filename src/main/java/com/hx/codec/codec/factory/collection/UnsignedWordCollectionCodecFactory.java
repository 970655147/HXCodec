...
import com.hx.codec.codec.collection.UnsignedWordCollectionCodec;
 ...
 */
public class UnsignedWordCollectionCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordCollectionCodec(byteOrder);
    }
