...
import com.hx.codec.codec.array.UnsignedWordArrayWithEleLenCodec;
 ...
 */
public class UnsignedWordArrayWithFixedLenCodecFactory implements AbstractCodecFactory<Integer[], Integer[]> {
    ...
    public AbstractCodec<Integer[], Integer[]> create(CodecFactoryContext context) {
        ...
        return new UnsignedWordArrayWithFixedLenCodec(byteOrder, fixedLength, paddingByte, paddingFirst);
    }
}