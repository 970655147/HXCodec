...
import com.hx.codec.codec.collection.UnsignedByteCollectionCodec;
 ...
 */
public class UnsignedByteCollectionCodecFactory implements AbstractCodecFactory<Collection<Integer>, Collection<Integer>> {
    ...
    public AbstractCodec<Collection<Integer>, Collection<Integer>> create(CodecFactoryContext context) {
        ...
        return new UnsignedByteCollectionCodec(byteOrder);
    }
