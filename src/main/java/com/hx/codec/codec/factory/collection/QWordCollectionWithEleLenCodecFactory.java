 ...
 */
public class QWordCollectionWithEleLenCodecFactory implements AbstractCodecFactory<Collection<Long>, Collection<Long>> {
    ...
    public AbstractCodec<Collection<Long>, Collection<Long>> create(CodecFactoryContext context) {
        ...
        return new QWordCollectionWithEleLenCodec(byteOrder, eleLength, paddingByte, paddingFirst);
    }
