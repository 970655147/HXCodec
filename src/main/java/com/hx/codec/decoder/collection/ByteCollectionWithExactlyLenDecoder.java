 ...
 */
public class ByteCollectionWithExactlyLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private ByteDecoder decoder;
    private int eleLength;

    public ByteCollectionWithExactlyLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new ByteDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public ByteCollectionWithExactlyLenDecoder(int eleLength) {
