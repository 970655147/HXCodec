 ...
 */
public class QWordCollectionWithFixedLenDecoder extends AbstractDecoder<Collection<Long>> {

    private QWordDecoder decoder;
    private int eleLength;

    public QWordCollectionWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new QWordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public QWordCollectionWithFixedLenDecoder(int eleLength) {
