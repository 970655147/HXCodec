 ...
 */
public class UnsignedWordCollectionWithLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private UnsignedWordDecoder decoder;
    private ByteType lenByteType;

    public UnsignedWordCollectionWithLenDecoder(ByteOrder byteOrder, ByteType lenByteType) {
        super(byteOrder);
        this.decoder = new UnsignedWordDecoder(byteOrder);
        this.lenByteType = lenByteType;
    }

    public UnsignedWordCollectionWithLenDecoder(ByteType lenByteType) {
        this(DEFAULT_BYTE_ORDER, lenByteType);
    }

    public UnsignedWordCollectionWithLenDecoder() {
