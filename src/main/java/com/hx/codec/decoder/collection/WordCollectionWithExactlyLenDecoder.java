 ...
 */
public class WordCollectionWithExactlyLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private WordDecoder decoder;
    private int eleLength;

    public WordCollectionWithExactlyLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new WordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public WordCollectionWithExactlyLenDecoder(int eleLength) {
