 ...
 */
public class WordCollectionWithFixedLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private WordDecoder decoder;
    private int eleLength;

    public WordCollectionWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new WordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public WordCollectionWithFixedLenDecoder(int eleLength) {
