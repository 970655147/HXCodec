 ...
 */
public class UnsignedWordCollectionWithExactlyLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private UnsignedWordDecoder decoder;
    private int eleLength;

    public UnsignedWordCollectionWithExactlyLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new UnsignedWordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public UnsignedWordCollectionWithExactlyLenDecoder(int eleLength) {
