 ...
 */
public class UnsignedByteCollectionWithFixedLenDecoder extends AbstractDecoder<Collection<Integer>> {

    private UnsignedByteDecoder decoder;
    private int eleLength;

    public UnsignedByteCollectionWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new UnsignedByteDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public UnsignedByteCollectionWithFixedLenDecoder(int eleLength) {
