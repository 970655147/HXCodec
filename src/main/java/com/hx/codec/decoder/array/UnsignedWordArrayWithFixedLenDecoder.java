 ...
 */
public class UnsignedWordArrayWithFixedLenDecoder extends AbstractDecoder<Integer[]> {

    private UnsignedWordDecoder decoder;
    private int eleLength;

    public UnsignedWordArrayWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new UnsignedWordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public UnsignedWordArrayWithFixedLenDecoder(int eleLength) {
