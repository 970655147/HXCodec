 ...
 */
public class ByteArrayWithFixedLenDecoder extends AbstractDecoder<Integer[]> {

    private ByteDecoder decoder;
    private int eleLength;

    public ByteArrayWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new ByteDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public ByteArrayWithFixedLenDecoder(int eleLength) {
