 ...
 */
public class DWordArrayWithFixedLenDecoder extends AbstractDecoder<Integer[]> {

    private DWordDecoder decoder;
    private int eleLength;

    public DWordArrayWithFixedLenDecoder(ByteOrder byteOrder, int eleLength) {
        super(byteOrder);
        this.decoder = new DWordDecoder(byteOrder);
        this.eleLength = eleLength;
    }

    public DWordArrayWithFixedLenDecoder(int eleLength) {
