 ...
 */
public class GenericBeanArrayWithFixedLenDecoder<T> extends AbstractDecoder<T[]> {

    private GenericBeanDecoder<T> decoder;
    private GenericBeanSchema<T> beanSchema;
    private int eleLength;

    public GenericBeanArrayWithFixedLenDecoder(GenericBeanSchema<T> beanSchema, int eleLength) {
