...
public class AssertUtils {
     ...
     * @return void
     * @author Jerry.X.He
     * @date 2021/9/19 15:08
     */
    public static void state(boolean expression, Exception e) throws Exception {
        if (!expression) {
            throw e;
        }
    }
    ...
    public static void hasText(String text, String message) {
        if (lengthOfString(trimString(text)) <= 0) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void doesNotContain(String textToSearch, String substring, String message) {
        if ((lengthOfString(trimString(textToSearch)) > 0)
                && (lengthOfString(trimString(substring)) > 0)
