...
package com.hx.codec.thirdparties.org.apache.commons.codec.digest;

import com.hx.codec.constants.CodecConstants;
import com.hx.codec.utils.HexUtils;
...
public class DigestUtils {
     ...
     * Calculates the MD2 digest and returns the value as a 16 element {@code byte[]}.
     *
     * @param data Data to digest; converted to bytes using {@link String#getBytes(String)}
     * @return MD2 digest
     * @since 1.7
     */
    public static byte[] md2(final String data) {
        return md2(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] md5(final String data) {
        return md5(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] sha1(final String data) {
        return sha1(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] sha256(final String data) {
        return sha256(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] sha3_224(final String data) {
        return sha3_224(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha3_224Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha3_224(data));
    }
    ...
    public static byte[] sha3_256(final String data) {
        return sha3_256(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha3_256Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha3_256(data));
    }
    ...
    public static byte[] sha3_384(final String data) {
        return sha3_384(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha3_384Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha3_384(data));
    }
    ...
    public static byte[] sha3_512(final String data) {
        return sha3_512(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha3_512Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha3_512(data));
    }
    ...
    public static byte[] sha384(final String data) {
        return sha384(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] sha512(final String data) {
        return sha512(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static byte[] sha512_224(final String data) {
        return sha512_224(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha512_224Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha512_224(data));
    }
    ...
    public static byte[] sha512_256(final String data) {
        return sha512_256(data.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public static String sha512_256Hex(final byte[] data) {
        return HexUtils.encodeHexString(sha512_256(data));
    }
     ...
     * @param messageDigest the {@link MessageDigest} to update
     * @param valueToDigest the value to update the {@link MessageDigest} with;
     *                      converted to bytes using {@link String#getBytes(String)}
     * @return the updated {@link MessageDigest}
     * @since 1.7
     */
    public static MessageDigest updateDigest(final MessageDigest messageDigest, final String valueToDigest) {
        messageDigest.update(valueToDigest.getBytes(CodecConstants.CHARSET_UTF8));
        return messageDigest;
    }
    ...
    public String digestAsHex(final Path data, final OpenOption... options) throws IOException {
        return HexUtils.encodeHexString(digest(data, options));
    }
