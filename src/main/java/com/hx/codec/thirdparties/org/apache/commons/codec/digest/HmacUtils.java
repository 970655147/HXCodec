...
public final class HmacUtils {
    ...
    public static Mac updateHmac(final Mac mac, final String valueToDigest) {
        mac.reset();
        mac.update(valueToDigest.getBytes(CodecConstants.CHARSET_UTF8));
        return mac;
    }
    ...
    public HmacUtils(final String algorithm, final String key) {
        this(algorithm, key.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public HmacUtils(final HmacAlgorithms algorithm, final String key) {
        this(algorithm.getName(), key.getBytes(CodecConstants.CHARSET_UTF8));
    }
    ...
    public String hmacHex(final byte[] valueToDigest) {
        return HexUtils.encodeHexString(hmac(valueToDigest));
    }
    ...
    public byte[] hmac(final String valueToDigest) {
        return mac.doFinal(valueToDigest.getBytes(CodecConstants.CHARSET_UTF8));
    }
