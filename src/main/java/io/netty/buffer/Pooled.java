 ...
 *
 * <pre>
 * import static io.netty.buffer.{@link io.netty.buffer.Pooled}.*;
 *
...
public final class Pooled {
    ...
    // disable follow methods, case there are no handle
    ...
    public static ByteBuf wrappedBuffer(byte[] array) {
        ...
        ByteBuf result = ALLOC.heapBuffer(array.length);
